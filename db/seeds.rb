User.create!([
  ...
  {email: "test@test.com", encrypted_password: "$2a$11$80sGzoyEp1vlT6fm5DDZDuk5azLkVsjgCbakRlxq/AQdnjZ./gmJO", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: "2016-06-24 15:44:57", sign_in_count: 20, current_sign_in_at: "2016-07-07 04:39:50", last_sign_in_at: "2016-07-07 04:39:49", current_sign_in_ip: "::1", last_sign_in_ip: "::1", admin: nil}
])
Answer.create!([
